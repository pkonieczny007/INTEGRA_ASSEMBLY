...
lista_plikow = """
MERGE- łączenie_plików_excel_po indeksie.py
roboczy_blachy.xlsx
roboczy_profile.xlsx
wykaz.xlsx
""".strip().split('\n')
...
# Tworzenie folderu "MERGE"
technol_folder = "MERGE"
os.makedirs(technol_folder, exist_ok=True)

# Pobranie danych z GitHub
github_url = "https://github.com/pkonieczny007/MERGE-laczenie_plikow_xlsx/archive/refs/heads/main.zip"
